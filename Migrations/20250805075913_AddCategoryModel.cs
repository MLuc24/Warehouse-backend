        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultMinStock = table.Column<int>(type: "int", nullable: true),
                    DefaultMaxStock = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Category__19093A0B5F8A3BC2", x => x.CategoryId);
                });
