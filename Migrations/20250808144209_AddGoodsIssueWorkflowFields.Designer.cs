...
namespace WarehouseManage.Migrations
{
    ...
    [Migration("20250808144209_AddGoodsIssueWorkflowFields")]
    partial class AddGoodsIssueWorkflowFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WarehouseManage.Model.GoodsReceipt", b =>
                {
                    ...
                    b.Property<string>("SupplierConfirmationToken")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool?>("SupplierConfirmed")
                        .HasColumnType("bit");

                    b.Property<DateTime?>("SupplierConfirmedDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("WarehouseManage.Model.GoodsIssue", b =>
                {
                    b.HasOne("WarehouseManage.Model.User", "ApprovedByUser")
                        .WithMany()
                        .HasForeignKey("ApprovedByUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .HasConstraintName("FK_GoodsIssues_ApprovedByUser");

                    b.HasOne("WarehouseManage.Model.User", "CompletedByUser")
                        .WithMany()
                    ...
                    b.HasOne("WarehouseManage.Model.User", "DeliveredByUser")
                        .WithMany()
                        .HasForeignKey("DeliveredByUserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .HasConstraintName("FK_GoodsIssues_DeliveredByUser");

                    b.HasOne("WarehouseManage.Model.User", "PreparedByUser")
                        .WithMany()
